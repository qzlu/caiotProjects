<template>
    <div class="login">
        <div class="login-box">
            <h2>欢迎登录</h2>
            <zw-card class="login-item" :width='456' :height='73' :cornerWidth='0' :cornerHeight='0' :borderWidth='0'>
...
import {Login} from '@/zhiwei/request/api.js'
...
.login{
    ...
    background: url(#{$img-url}login.jpg);
    position: relative;
    &-box{
        width: 651px;
        height: 498px;
