               ...
               <el-table-column
                 ...
                 <template slot-scope="scoped">
                     <div class="role-operation">
                        ...
                        <span v-if="isShowUpdate" class="pointer" title="编辑" @click="editItem(scoped.row)">编辑</span>
                        <span class="pointer" title="删除" v-if="isShowDelete&&deleteRow" @click="deleteItem(scoped.row)">删除</span>
                     </div>
                 </template>
               </el-table-column>
            </el-table>
...
export default {
    ...
    computed:{
         ...
         */
        isShowUpdate(){
            return this.buttonList&&this.buttonList.find(item => item.FURL == 2)?true:false
        },
        /**
         * 是否有删除权限
         */
        isShowDelete(){
            return this.buttonList&&this.buttonList.find(item => item.FURL == 3)?true:false
        },
        isRead(){
            return this.buttonList&&this.buttonList.find(item => item.FURL == 4)?true:false
        },
        /**
         * 是否有导出权限
         */
        isExport(){
            return this.buttonList&&this.buttonList.find(item => item.FURL == 5)?true:false
        }
