<template>
    <div class=" road report">
        ...
        <div class="point-info">
            ...
            <el-dialog title="设置巡检点" :visible.sync="showPointTree" width="680px" class="zw-dialog showPointTree">
...
<script>
import {system,Inspection} from '@/caiot/request/api.js'//api接口（接口统一管理）;
