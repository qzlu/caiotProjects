    ...
    <div class="left">
			...
			<ul>
				<li class="top">
					...
					<div class="sd"><!--<img src="/static/image/index/leftbar_icon_1.png">-->
...
.monitoring .m_right{  width: 1565px; float: left; }
...
.monitoring .left { width: 299px; overflow: hidden; padding: 0 20px 0 22px; float: left;}
